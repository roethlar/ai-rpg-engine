...
const branchSpecs = [
  ...
  },
  {
    ...
    grants: [
      ...
      action('Mobile Bastion', 'Once per scene, move one of your active installations to an adjacent legal area and mend its recorded durability. It retains its identity and consumes your Main.', { targeting: { kind: 'installation', range: 'near', maximum: 1 }, cadence: scene(), check: null, mechanic: { kind: 'device', mode: 'relocate', maximumDistance: 1, repair: 8 } }),
