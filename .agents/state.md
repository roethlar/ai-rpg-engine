...
- Heroic/map layout mocks at `docs/mockups/heroic-layouts.html` (also published as artifact). Owner feedback 2026-07-03: B best of the static three; A wastes a rail; C too squeezed; wants dynamic. Layout D (dynamic spotlight: one info rail, click-to-focus any surface, Esc restores) added in response — awaiting owner verdict; a pick unblocks promoting the maps/heroic phase.
