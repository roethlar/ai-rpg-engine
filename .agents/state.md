...
- `.agents/review/interaction-burden-audit.md` — current text-entry fit audit and roster/economy recommendations; no owner ruling yet.
- `.agents/review/archetype-collapse-prototypes.md` — matched-card evidence: Intruder removed; Adept formally differs but fails the later interaction recommendation.
