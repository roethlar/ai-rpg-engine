...
- a full-height contextual rules pane that owns the right side, keeps selected choices visible, previews hovered or focused choices, and becomes a mobile drawer;
