...
| D3 | Archetype boundary | Stable chassis archetypes, flavor-skinned | V2 portability plan drafted 2026-07-27 (`.agents/review/archetype-portability-matrix-v2.md`) after independent v1 review; awaiting the owner's first architecture ruling. D2 prerequisite is satisfied. |
