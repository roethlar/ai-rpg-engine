...
- D3's 2026-07-31 approvals retain their wording/canon/ordering authority, but the 2026-08-02
  ...
  call. S1.1 through S1.4 are landed; S1.5 requires the version-plan revision, Gate 5's catalog,
  and the open description-scope ruling recorded in `findings/pt-5.md`. Remaining D13/D16 work
  stays deferred.
...
| D3 | Archetype boundary | Stable player-facing archetypes; campaign-tailored descriptions | **PARTIALLY SUPERSEDED 2026-08-02; VERSION REPLAN DRAFTED 2026-09-05.** `.agents/decisions.md` owns settled compatibility/upgrades and simple player-key/admin-reset decisions; `campaign-character-version-plan.md` applies them without another compatibility approval gate. S1.1-S1.4 are landed. No further code is approved; remaining design work is taxonomy/catalog, mechanics and `findings/pt-5.md` description scope. |
...
| D13 | Legacy/versioning/freeform | Legacy tier, pinned chassis, explicit `rules_mode` decision | Partially settled by the 2026-08-02 campaign/character-version decision in `.agents/decisions.md`; legacy/freeform disposition and implementation remain open. |
