...
| D3 | Archetype boundary | Stable player-facing archetypes; campaign-tailored descriptions | **PARTIALLY SUPERSEDED 2026-08-02; VERSION REPLAN DRAFTED 2026-09-05.** `.agents/decisions.md` owns the replacement contract and reusable-player-key choice; `campaign-character-version-plan.md` owns the proposed architecture, open key-recovery decision and delivery/verification gates. S1.1-S1.4 are landed. No further code is approved; taxonomy, catalog and `findings/pt-5.md` remain separate decisions. |
