...
| v-2 | HIGH | OpenAI-only/free-text profiles lose identity across providers, forks, and imports | `[x]` accepted; merging under standing go | `fix/v-2-portable-voice-profiles` |
