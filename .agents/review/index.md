...
| am-3 | HIGH | Repeated forms cannot share credentials or assign reusable primary/fallback models | `[~]` reopened: legacy clear semantics | `feat/am-3-admin-model-registry-ui` |
