...
| css-1 | MEDIUM | Pre-existing: `rgba(var(--theme-*), α)` over HSL-triple vars is invalid CSS — header/glass/panel fills compute unpainted on every theme | `[x]` ACCEPTED at r5 — guard_confirmed true; owner-gated merge | `fix/css-1-hsla-theme-vars` @ `09bb433` |
