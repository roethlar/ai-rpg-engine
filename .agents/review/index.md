...
| v-3 | HIGH | Host/seat voice resolution diverges and identical playback multiplies provider calls | `[~]` pending independent review | `fix/v-3-canonical-voice-route` |
