...
| v-2 | HIGH | OpenAI-only/free-text profiles lose identity across providers, forks, and imports | `[~]` implementation complete; pending review | `fix/v-2-portable-voice-profiles` |
