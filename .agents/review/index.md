...
| am-2 | HIGH | Catalog discovery can leak keys or bypass production endpoint policy | `[~]` accepted at `bcfe223`; body-timeout follow-up pending | `feat/am-2-provider-catalogs` |
