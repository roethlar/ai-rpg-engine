...
| ID | Severity | Impact (one line) | Status | Branch |
|----|----------|-------------------|--------|--------|
| qr-1 | HIGH | A committed turn omitting quest_update reset the campaign quest to a placeholder, then fed it back to the GM as truth | `[x]` verified; merged (kimi/kimi-code-k3/max — guard EXECUTED) | `qr-1-quest-fallback` |
