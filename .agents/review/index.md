...
| am-2 | HIGH | Catalog discovery can leak keys or bypass production endpoint policy | `[~]` body-timeout fix `0578115` pending Fable re-review | `feat/am-2-provider-catalogs` |
