...
**Current decision:** campaign/character compatibility, section 10, item 2. Key recovery is settled;
do not reopen it or add an authentication decision queue before returning to game behavior.
