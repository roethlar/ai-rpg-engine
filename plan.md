...
- **Cross-genre character translation — D3 DRAFT v2 (2026-07-27).** The active working plan is
  `.agents/review/archetype-portability-matrix-v2.md`, incorporating the independent v1 review.
  It proposes internal functional kernels, destination expressions, distinct
  Continue/Branch/Translate modes, D2-bound mechanical fingerprints, and mandatory player
  approval. No D3 decision or code authorization exists; character-creation composition,
  ability packaging, and D13/D16 non-ability state remain explicit owner gates.
